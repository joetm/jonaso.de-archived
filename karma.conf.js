// Karma configuration
// Generated on Wed Jul 15 2015 16:50:12 GMT+0100 (GMT Daylight Time)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        {pattern: 'prod/css/*.css', watched: false, served: true, included: true},
        {pattern: 'data/*.json', watched: true, served: true, included: false},
        {pattern: 'token.php', watched: false, served: true, included: false},
        'test/**/*Spec.js'
    ],
